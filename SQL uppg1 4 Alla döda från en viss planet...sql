SELECT tblPassangers.Fname, tblPassangers.Lname, tblDeathCause.DeathCause, tblPlanets.PlanetName, DeathDate
FROM     tblDeathCause INNER JOIN
                  ...
                  tblRang ON tblPassangers.RangID = tblRang.RangID WHERE tblPlanets.PlanetName='EARTH'