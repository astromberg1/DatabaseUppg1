SELECT tblPassangers.Fname, tblPassangers.Lname, tblDeathCause.DeathCause, DeathDate
FROM     tblDeathCause INNER JOIN
                  ...
                  tblRang ON tblPassangers.RangID = tblRang.RangID WHERE DeathDate BETWEEN '2015-01-01' AND '2015-10-30'